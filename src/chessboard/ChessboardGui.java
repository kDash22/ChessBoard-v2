...
public class ChessboardGui extends JPanel {
    ...
    public void loadPieces() {
        try {
            //white
            wPawn = new ImageIcon(getClass().getResource("/pieceimagess/white/white-pawn.png")).getImage();
            wKnight = new ImageIcon(getClass().getResource("/pieceimagess/white/white-knight.png")).getImage();
            wBishop = new ImageIcon(getClass().getResource("/pieceimagess/white/white-bishop.png")).getImage();
            wRook = new ImageIcon(getClass().getResource("/pieceimagess/white/white-rook.png")).getImage();
            wQueen = new ImageIcon(getClass().getResource("/pieceimagess/white/white-queen.png")).getImage();
            wKing = new ImageIcon(getClass().getResource("/pieceimagess/white/white-king.png")).getImage();

            //black
            bPawn = new ImageIcon(getClass().getResource("/pieceimagess/black/black-pawn.png")).getImage();
            bKnight = new ImageIcon(getClass().getResource("/pieceimagess/black/black-knight.png")).getImage();
            bBishop = new ImageIcon(getClass().getResource("/pieceimagess/black/black-bishop.png")).getImage();
            bRook = new ImageIcon(getClass().getResource("/pieceimagess/black/black-rook.png")).getImage();
            bQueen = new ImageIcon(getClass().getResource("/pieceimagess/black/black-queen.png")).getImage();
            bKing = new ImageIcon(getClass().getResource("/pieceimagess/black/black-king.png")).getImage();
        } catch (Exception e) {
    ...
    public Image getPieceImage(Piece piece){
        ...
        return switch(piece){
            ...
            case Queen queen -> piece.isWhite() ? wRook : bRook;
